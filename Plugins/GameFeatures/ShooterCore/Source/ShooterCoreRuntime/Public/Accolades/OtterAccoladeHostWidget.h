...
#include "Accolades/OtterAccoladeDefinition.h"
#include "AsyncMixin.h"
#include "CommonUserWidget.h"
#include "GameFramework/GameplayMessageSubsystem.h"

#include "OtterAccoladeHostWidget.generated.h"

class UObject;
class USoundBase;
class UUserWidget;
struct FDataRegistryAcquireResult;
struct FOtterNotificationMessage;
...
struct FPendingAccoladeEntry
{
	...
	FOtterAccoladeDefinitionRow Row; 
...
class UOtterAccoladeHostWidget : public UCommonUserWidget, public FAsyncMixin
{
	GENERATED_BODY()
...
private:
	...
	void OnNotificationMessage(FGameplayTag Channel, const FOtterNotificationMessage& Notification);
