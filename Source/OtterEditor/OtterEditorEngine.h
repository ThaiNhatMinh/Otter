...
#include "OtterEditorEngine.generated.h"
...
UCLASS()
class UOtterEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	UOtterEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
