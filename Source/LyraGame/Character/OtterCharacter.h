...
/**
 * FOtterReplicatedAcceleration: Compressed representation of acceleration
 */
USTRUCT()
struct FOtterReplicatedAcceleration
{
	GENERATED_BODY()
...
class LYRAGAME_API AOtterCharacter : public AModularCharacter, public IAbilitySystemInterface, public IGameplayCueInterface, public IGameplayTagAssetInterface, public IOtterTeamAgentInterface
{
	GENERATED_BODY()
...
private:
	...
	FOtterReplicatedAcceleration ReplicatedAcceleration;
