 ...
 */
UCLASS()
class LYRAGAME_API UOtterInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class LYRAGAME_API UOtterPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
