...
#include "OtterBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UOtterBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UOtterBrightnessEditor(const FObjectInitializer& Initializer);
