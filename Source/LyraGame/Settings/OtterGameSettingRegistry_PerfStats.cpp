...
#include "CustomSettings/OtterSettingValueDiscrete_PerfStat.h"
...
void UOtterGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UOtterLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EOtterDisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::ClientFPS);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::ServerFPS);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::FrameTime);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::IdleTime);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::Ping);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UOtterSettingValueDiscrete_PerfStat* Setting = NewObject<UOtterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EOtterDisplayablePerformanceStat::PacketSize_Outgoing);
