...
#include "OtterSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UOtterSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UOtterSettingValueDiscrete_Resolution();
