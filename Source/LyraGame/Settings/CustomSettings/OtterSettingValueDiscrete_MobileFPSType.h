...
//#include "Settings/OtterMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "OtterSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UOtterSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UOtterSettingValueDiscrete_MobileFPSType();
