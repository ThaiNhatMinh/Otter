...
#include "OtterSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UOtterSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UOtterSettingValueDiscreteDynamic_AudioOutputDevice() = default;
