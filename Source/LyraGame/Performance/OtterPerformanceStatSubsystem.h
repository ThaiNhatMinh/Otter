...
#include "OtterPerformanceStatSubsystem.generated.h"
...
struct FOtterPerformanceStatCache : public IPerformanceDataConsumer
{
public:
	FOtterPerformanceStatCache(UOtterPerformanceStatSubsystem* InSubsystem)
	...
	double GetCachedStat(EOtterDisplayablePerformanceStat Stat) const;

protected:
	IPerformanceDataConsumer::FFrameData CachedData;
	UOtterPerformanceStatSubsystem* MySubsystem;
...
class UOtterPerformanceStatSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	TSharedPtr<FOtterPerformanceStatCache> Tracker;
};
