...
#include "OtterPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "OtterCheats"

UOtterPlatformEmulationSettings::UOtterPlatformEmulationSettings()
{
}

FName UOtterPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UOtterPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UOtterPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UOtterPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UOtterPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UOtterPlatformEmulationSettings::PostInitProperties()
{
...
void UOtterPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UOtterPlatformEmulationSettings::ApplySettings()
{
...
void UOtterPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UOtterPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UOtterPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UOtterPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
