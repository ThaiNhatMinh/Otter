...
#include "OtterCharacterPartTypes.generated.h"
...
struct FOtterCharacterPartHandle
{
	GENERATED_BODY()
...
struct FOtterCharacterPart
{
	...
	static bool AreEquivalentParts(const FOtterCharacterPart& A, const FOtterCharacterPart& B)
	{
