...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterHotfixManager)

int32 UOtterHotfixManager::GameHotfixCounter = 0;

UOtterHotfixManager::UOtterHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UOtterHotfixManager::GetOnScreenMessages);
...
void UOtterHotfixManager::Init()
{
	Super::Init();
}

void UOtterHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UOtterSettingsLocal* GameSettings = UOtterSettingsLocal::Get();
...
bool UOtterHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UOtterHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UOtterHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UOtterHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UOtterHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UOtterHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UOtterHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UOtterHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UOtterHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
