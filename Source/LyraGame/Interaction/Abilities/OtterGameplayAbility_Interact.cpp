...
#include "OtterGameplayAbility_Interact.h"
...
#include "UI/IndicatorSystem/OtterIndicatorManagerComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterGameplayAbility_Interact)
...
UOtterGameplayAbility_Interact::UOtterGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = EOtterAbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UOtterGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UOtterGameplayAbility_Interact::TriggerInteraction()
{
