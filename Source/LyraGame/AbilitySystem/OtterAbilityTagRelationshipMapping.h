...
#include "OtterAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FOtterAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UOtterAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FOtterAbilityTagRelationship> AbilityTagRelationships;
