...
#include "OtterGamePhaseAbility.generated.h"

/**
 * UOtterGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UOtterGamePhaseAbility : public UOtterGameplayAbility
{
	GENERATED_BODY()

public:

	UOtterGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Otter|Game Phase")
