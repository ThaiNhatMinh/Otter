...
#include "OtterGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterGameViewportClient)
...
UOtterGameViewportClient::UOtterGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UOtterGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
