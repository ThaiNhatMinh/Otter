...
#include "OtterSettingScreen.generated.h"

class UGameSettingRegistry;
class UOtterTabListWidgetBase;
class UObject;

UCLASS(Abstract, meta = (Category = "Settings", DisableNativeTick))
class UOtterSettingScreen : public UGameSettingScreen
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<UOtterTabListWidgetBase> TopSettingsTabs;
