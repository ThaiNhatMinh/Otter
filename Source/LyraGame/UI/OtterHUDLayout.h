...
#include "OtterHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
class UOtterControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "Otter HUD Layout", Category = "Otter|HUD"))
class UOtterHUDLayout : public UOtterActivatableWidget
{
	GENERATED_BODY()

public:

	UOtterHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	TSubclassOf<UOtterControllerDisconnectedScreen> ControllerDisconnectedScreen;
