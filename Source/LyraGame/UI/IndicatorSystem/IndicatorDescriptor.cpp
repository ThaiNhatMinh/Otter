...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UOtterIndicatorManagerComponent* InManager)
{
...
{
	if (UOtterIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
