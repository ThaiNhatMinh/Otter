...
#include "OtterFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class UOtterFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	UOtterFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
