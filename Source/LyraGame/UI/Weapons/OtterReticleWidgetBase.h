...
#include "OtterReticleWidgetBase.generated.h"
...
UCLASS(Abstract)
class UOtterReticleWidgetBase : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UOtterReticleWidgetBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintImplementableEvent)
	void OnWeaponInitialized();

	UFUNCTION(BlueprintCallable)
	void InitializeFromWeapon(UOtterWeaponInstance* InWeapon);
...
protected:
	...
	TObjectPtr<UOtterWeaponInstance> WeaponInstance;

	UPROPERTY(BlueprintReadOnly)
	TObjectPtr<UOtterInventoryItemInstance> InventoryInstance;
};
