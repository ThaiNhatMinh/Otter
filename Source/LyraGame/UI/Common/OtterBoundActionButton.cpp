...
#include "OtterBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterBoundActionButton)

class UCommonButtonStyle;

void UOtterBoundActionButton::NativeConstruct()
{
...
void UOtterBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
