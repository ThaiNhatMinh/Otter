...
#include "OtterWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterWidgetFactory_Class)

TSubclassOf<UUserWidget> UOtterWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
