...
struct LYRAGAME_API FOtterContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class LYRAGAME_API UOtterActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class LYRAGAME_API UOtterContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
