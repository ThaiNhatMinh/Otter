...
struct LYRAGAME_API FOtterContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct LYRAGAME_API FOtterContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct LYRAGAME_API FOtterContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct LYRAGAME_API FOtterContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class LYRAGAME_API UAnimNotify_OtterContextEffects : public UAnimNotify
{
	GENERATED_BODY()
