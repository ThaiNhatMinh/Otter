...
#include "OtterNumberPopComponent_NiagaraText.h"

#include "Feedback/NumberPops/OtterNumberPopComponent.h"
#include "OtterDamagePopStyleNiagara.h"
#include "OtterLogChannels.h"
#include "NiagaraComponent.h"
#include "NiagaraDataInterfaceArrayFunctionLibrary.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterNumberPopComponent_NiagaraText)

UOtterNumberPopComponent_NiagaraText::UOtterNumberPopComponent_NiagaraText(const FObjectInitializer& ObjectInitializer)
...
void UOtterNumberPopComponent_NiagaraText::AddNumberPop(const FOtterNumberPopRequest& NewRequest)
{
	...
	UE_LOG(LogOtter, Log, TEXT("DamageHit location : %s"), *(NewRequest.WorldLocation.ToString()));
