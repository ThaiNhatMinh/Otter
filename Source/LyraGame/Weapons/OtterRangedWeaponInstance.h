...
#include "OtterRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UOtterRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UOtterRangedWeaponInstance : public UOtterWeaponInstance, public IOtterAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UOtterRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UOtterEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UOtterEquipmentInstance interface

	void AddSpread();

	//~IOtterAbilitySourceInterface interface
	...
	//~End of IOtterAbilitySourceInterface interface
