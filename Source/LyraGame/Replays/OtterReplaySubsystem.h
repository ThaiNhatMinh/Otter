...
class LYRAGAME_API UOtterReplayListEntry : public UObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class LYRAGAME_API UOtterReplayList : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class LYRAGAME_API UOtterReplaySubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
