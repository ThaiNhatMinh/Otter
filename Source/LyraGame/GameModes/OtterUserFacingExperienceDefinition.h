...
#include "OtterUserFacingExperienceDefinition.generated.h"
...
class UOtterUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="OtterExperienceDefinition"))
