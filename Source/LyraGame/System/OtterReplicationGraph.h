...
#include "OtterReplicationGraph.generated.h"

class AGameplayDebuggerCategoryReplicator;

DECLARE_LOG_CATEGORY_EXTERN(LogOtterRepGraph, Display, All);

/** Otter Replication Graph implementation. See additional notes in OtterReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class UOtterReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	UOtterReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UOtterReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UOtterReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UOtterReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
