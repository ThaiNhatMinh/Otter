...
#include "OtterDevelopmentStatics.generated.h"
...
UCLASS()
class UOtterDevelopmentStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	// Should game logic skip directly to gameplay (skipping any match warmup / waiting for players / etc... aspects)
	// Will always return false except when playing in the editor and bTestFullGameFlowInPIE (in Otter Developer Settings) is false
	...
	// Will always return true except when playing in the editor and bSkipLoadingCosmeticBackgroundsInPIE (in Otter Developer Settings) is true
	UFUNCTION(BlueprintCallable, Category = "Otter", meta=(ExpandBoolAsExecs="ReturnValue"))
