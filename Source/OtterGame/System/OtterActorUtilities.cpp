...
#include "OtterActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterActorUtilities)

EBlueprintExposedNetMode UOtterActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
