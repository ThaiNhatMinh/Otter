...
UCLASS()
class UOtterSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Otter", meta = (WorldContext = "WorldContextObject"))
