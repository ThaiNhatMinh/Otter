...
#include "OtterNumberPopComponent_MeshText.h"

#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Engine/Engine.h"
#include "Engine/World.h"
#include "Feedback/NumberPops/OtterNumberPopComponent.h"
#include "OtterDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterNumberPopComponent_MeshText)

class UStaticMesh;

UOtterNumberPopComponent_MeshText::UOtterNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UOtterNumberPopComponent_MeshText::AddNumberPop(const FOtterNumberPopRequest& NewRequest)
{
...
void UOtterNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UOtterNumberPopComponent_MeshText::DetermineColor(const FOtterNumberPopRequest& Request) const
{
	for (UOtterDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UOtterNumberPopComponent_MeshText::DetermineStaticMesh(const FOtterNumberPopRequest& Request) const
{
	for (UOtterDamagePopStyle* Style : Styles)
	{
...
void UOtterNumberPopComponent_MeshText::SetMaterialParameters(const FOtterNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
