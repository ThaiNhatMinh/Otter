...
#include "OtterContextEffectsInterface.generated.h"
 ...
 */
 ...
 class OTTERGAME_API UOtterContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class OTTERGAME_API IOtterContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
