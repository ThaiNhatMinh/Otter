...
#include "OtterContextEffectComponent.generated.h"
...
class OTTERGAME_API UOtterContextEffectComponent : public UActorComponent, public IOtterContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UOtterContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UOtterContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UOtterContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UOtterContextEffectsLibrary>> CurrentContextEffectsLibraries;
