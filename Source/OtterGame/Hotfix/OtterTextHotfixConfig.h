...
#include "OtterTextHotfixConfig.generated.h"
...
class UOtterTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	UOtterTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
