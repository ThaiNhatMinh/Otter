...
#include "OtterRuntimeOptions.generated.h"

class UObject;
struct FFrame;

/**
 * UOtterRuntimeOptions: Supports checking at runtime whether features are enabled/disabled, changing
...
class OTTERGAME_API UOtterRuntimeOptions : public URuntimeOptionsBase
{
	GENERATED_BODY()

public:
	static const UOtterRuntimeOptions& Get();

	UOtterRuntimeOptions();

	UFUNCTION(BlueprintPure, Category = Options)
	static UOtterRuntimeOptions* GetRuntimeOptions();
};
