...
#include "OtterGameplayCueManager.generated.h"
...
/**
 * UOtterGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UOtterGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UOtterGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UOtterGameplayCueManager* Get();
