...
#include "OtterSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "OtterSettings"

UOtterSettingValueDiscrete_Resolution::UOtterSettingValueDiscrete_Resolution()
{
}

void UOtterSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UOtterSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UOtterSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UOtterSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UOtterSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UOtterSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UOtterSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UOtterSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UOtterSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UOtterSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UOtterSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UOtterSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UOtterSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UOtterSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UOtterSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UOtterSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
