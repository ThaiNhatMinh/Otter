...
#include "OtterSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/OtterSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "OtterSettings"

UOtterSettingValueDiscrete_OverallQuality::UOtterSettingValueDiscrete_OverallQuality()
{
}

void UOtterSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void UOtterSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UOtterSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UOtterSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UOtterSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UOtterSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UOtterSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UOtterSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UOtterSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
