...
#include "OtterSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UOtterSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UOtterSafeZoneEditor(const FObjectInitializer& Initializer);
