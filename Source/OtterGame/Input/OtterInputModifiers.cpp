...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogOtterInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// OtterInputModifiersHelpers

namespace OtterInputModifiersHelpers
{
	/** Returns the owning OtterLocalPlayer of an Enhanced Player Input pointer */
	static UOtterLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UOtterLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UOtterSettingBasedScalar

FInputActionValue UOtterSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UOtterLocalPlayer* LocalPlayer = OtterInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UOtterSettingsShared::StaticClass();
			UOtterSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UOtterInputModifierDeadZone

FInputActionValue UOtterInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UOtterLocalPlayer* LocalPlayer = OtterInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}
	
	UOtterSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UOtterInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UOtterInputModifierGamepadSensitivity

FInputActionValue UOtterInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EOtterGamepadSensitivity Sensitivity = (TargetingType == EOtterTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UOtterInputModifierAimInversion

FInputActionValue UOtterInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UOtterLocalPlayer* LocalPlayer = OtterInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
