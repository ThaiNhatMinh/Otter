...
#include "OtterInputModifiers.generated.h"
...
class UOtterSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
/**
 * This is a deadzone input modifier that will have it's thresholds driven by what is in the Otter Shared game settings. 
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Otter Settings Driven Dead Zone"))
class UOtterInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EOtterTargetingType : uint8
{
...
/** Applies a scalar modifier based on the current gamepad settings in Otter Shared game settings.  */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Otter Gamepad Sensitivity"))
class UOtterInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
	...
	TObjectPtr<const UOtterAimSensitivityData> SensitivityLevelTable;

protected:
	virtual FInputActionValue ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime) override;
};

/** Applies an inversion of axis values based on a setting in the Otter Shared game settings */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Otter Aim Inversion Setting"))
class UOtterInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
