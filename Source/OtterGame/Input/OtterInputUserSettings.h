...
#include "OtterInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Otter game.
 * This will be serialized out at the same time as the Otter Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class OTTERGAME_API UOtterInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class OTTERGAME_API UOtterPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
