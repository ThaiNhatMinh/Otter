...
#include "OtterUserFacingExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UOtterUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	if (UOtterReplaySubsystem::DoesPlatformSupportReplays())
	{
		if (bRecordReplay)
		{
