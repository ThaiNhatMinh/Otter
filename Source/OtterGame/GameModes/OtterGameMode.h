...
#include "OtterGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnOtterGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class OTTERGAME_API AOtterGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AOtterGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Otter|Pawn")
	const UOtterPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnOtterGameModePlayerInitialized OnGameModePlayerInitialized;
