...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterExperienceDefinition)

#define LOCTEXT_NAMESPACE "OtterSystem"

UOtterExperienceDefinition::UOtterExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UOtterExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UOtterExperienceDefinition::UpdateAssetBundleData()
{
