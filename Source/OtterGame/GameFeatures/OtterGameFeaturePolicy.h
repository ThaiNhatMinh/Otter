...
#include "OtterGameFeaturePolicy.generated.h"
...
class UOtterGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	OTTERGAME_API static UOtterGameFeaturePolicy& Get();

	UOtterGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UOtterGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
...
// checked
UCLASS()
class UOtterGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
