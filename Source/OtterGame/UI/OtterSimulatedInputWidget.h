...
#include "OtterSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Otter Simulated Input Widget" ))
class OTTERGAME_API UOtterSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UOtterSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
