...
#include "OtterTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UOtterTaggedWidget::UOtterTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UOtterTaggedWidget::NativeConstruct()
{
...
void UOtterTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UOtterTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UOtterTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
