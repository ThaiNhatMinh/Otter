...
#include "OtterControllerDisconnectedScreen.generated.h"
...
class UOtterControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UOtterControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
