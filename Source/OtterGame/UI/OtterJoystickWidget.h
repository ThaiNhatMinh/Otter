...
#include "OtterJoystickWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Otter Joystick" ))
class OTTERGAME_API UOtterJoystickWidget : public UOtterSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UOtterJoystickWidget(const FObjectInitializer& ObjectInitializer);
