...
#include "OtterCosmeticAnimationTypes.generated.h"
...
struct FOtterAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FOtterAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FOtterAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FOtterAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FOtterAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FOtterAnimBodyStyleSelectionEntry> MeshRules;
