...
class OTTERGAME_API UOtterHeroComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()
...
public:
	...
	static UOtterHeroComponent* FindHeroComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UOtterHeroComponent>() : nullptr); }
