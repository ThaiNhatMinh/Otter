...
#include "OtterVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OtterVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FOtterVerbMessage

FString FOtterVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FOtterVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UOtterVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UOtterVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UOtterVerbMessageHelpers::VerbMessageToCueParameters(const FOtterVerbMessage& Message)
{
...
FOtterVerbMessage UOtterVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FOtterVerbMessage Result;
