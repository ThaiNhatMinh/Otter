...
#include "OtterWeaponInstance.generated.h"
 ...
 */
UCLASS()
class OTTERGAME_API UOtterWeaponInstance : public UOtterEquipmentInstance
{
	GENERATED_BODY()

public:
	UOtterWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FOtterAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FOtterAnimLayerSelectionSet UneuippedAnimSet;
