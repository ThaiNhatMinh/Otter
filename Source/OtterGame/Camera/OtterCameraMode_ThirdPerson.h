...
#include "OtterPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "OtterCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UOtterCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UOtterCameraMode_ThirdPerson : public UOtterCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FOtterPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
